export default function About() {
    return (
      <div>
        <h1>About Me</h1>
        <p>My name is Holden Garrison. I am from Jacksonville, Florida. I’ve recently begun my journey to become a web developer with the help of the UCF coding bootcamp. I am also currently a student at Arizona State University in the  online software engineering program. While CSS and HTML are new two me I do have experience in Java and C++ through my coursework at ASU, as well as some experience in Javascript through self study.
            </p>
